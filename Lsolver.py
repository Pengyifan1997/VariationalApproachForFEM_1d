...
ivmatrix = np.loadtxt('/Users/pengyifan/Desktop/1d_vaob/testfunction_%d_%d/grid_%d_%d/LinearBasis/LinearBasis.txt'%(M,D,Nc,K))
...
plt.figure(0)
plt.plot(xx,yy)
plt.savefig('/Users/pengyifan/Desktop/1d_vaob/testfunction_%d_%d/grid_%d_%d/LinearBasis/lossdecay.png'%(M,D,Nc,K))

print(t,Lossa)

Ta.requires_grad = False
curr_T = Ta.numpy()

np.savetxt('/Users/pengyifan/Desktop/1d_vaob/testfunction_%d_%d/grid_%d_%d/LinearBasis/transformmatrix.txt'%(M,D,Nc,K),curr_T)
...
for i in range(1,Nc + 1):
    ...
    plt.savefig('/Users/pengyifan/Desktop/1d_vaob/testfunction_%d_%d/grid_%d_%d/LinearBasis/figure_%d.png'%(M,D,Nc,K,i))

Loss = np.sqrt(Lossa/(Nf + 1)/(M))

print(Loss)

np.savetxt('/Users/pengyifan/Desktop/1d_vaob/testfunction_%d_%d/grid_%d_%d/LinearBasis/loss.txt'%(M,D,Nc,K),Loss)
