...
ivmatrix = np.loadtxt('/Users/pengyifan/Desktop/1d_vaob/testfunction_%d_%d/grid_%d_%d/MSFBasis/MSFBasis.txt'%(M,D,Nc,K))
...
plt.figure(0)
plt.plot(xx,yy)
plt.savefig('/Users/pengyifan/Desktop/1d_vaob/testfunction_%d_%d/grid_%d_%d/MSFBasis/lossdecay.png'%(M,D,Nc,K))
...
for i in range(1,Nc + 1):
    ...
    plt.savefig('/Users/pengyifan/Desktop/1d_vaob/testfunction_%d_%d/grid_%d_%d/MSFBasis/figure_%d.png'%(M,D,Nc,K,i))

Loss = np.sqrt(Lossa/(Nf + 1)/(M))

print(Loss)

np.savetxt('/Users/pengyifan/Desktop/1d_vaob/testfunction_%d_%d/grid_%d_%d/MSFBasis/loss.txt'%(M,D,Nc,K),Loss)